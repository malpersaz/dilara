...
return [
    ...
    [
        ...
        'key' => 'sales.payment_methods.kuveytturk',
        'name' => 'Kuveyt Türk Sanal POS',
        'info' => 'Kuveyt Türk Sanal POS Ödeme Yöntemi Ayarları',
        'sort' => 5,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'merchant_id',
                'title' => 'Mağaza No (Merchant ID)',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'info' => 'Kuveyt Türk tarafından verilen Mağaza Numarası',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'customer_id',
                'title' => 'Müşteri No (Customer ID)',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'info' => 'Kuveyt Türk tarafından verilen Müşteri Numarası',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'username',
                'title' => 'API Kullanıcı Adı (Username)',
                'type' => 'text',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'info' => 'Kuveyt Türk Sanal POS yönetim panelinden oluşturulan API kullanıcısı',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'password',
                'title' => 'API Şifresi (Password)',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'info' => 'Kuveyt Türk Sanal POS yönetim panelinden oluşturulan API kullanıcısının şifresi',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'sandbox',
